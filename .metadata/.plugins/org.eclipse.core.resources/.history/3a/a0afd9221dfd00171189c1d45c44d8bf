...
<body background="Imm/bianco.jpg">
	<div id="selezione">
		...
		<p id="JustForMe"> </p>
		<ul>
			<li class="Uomo"><button onclick="cambio('Tutto','M','null',1)">Uomo</button>
				<ul>
					<li id="scarpeu"><button onclick="cambio('Scarpa','M','null',1)"> Scarpe </button></li>	
					<li id="accessoriu" ><button onclick="cambio('Borsa','M','null',1)">Borse </button></li>
				</ul>
			</li>
			<li class="Donna"><button onclick="cambio('Tutto','D','null',1)">Donna</button>
				<ul>
					<li id="scarped"> <button onclick="cambio('Scarpa','D','null',1)">Scarpe</button></li>
					<li id="accessorid"><button onclick="cambio('Borsa','D','null',1)">Borse</button></li>
				</ul>
			</li>
		</ul>
	</div>
